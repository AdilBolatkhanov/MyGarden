...
import com.example.mygarden2.databinding.FragmentPlantDetailBinding
import com.example.mygarden2.utilities.InjectorUtils
import com.example.mygarden2.viewmodels.PlantDetailViewModel
    ...
    override fun onCreateView(
        ...
        plantDetailViewModel.isPlanted.observe(viewLifecycleOwner, Observer {
            if (it) {
                ...
                binding.fab.setImageDrawable(ContextCompat.getDrawable(requireContext(),R.drawable.ic_baseline_delete_24))
            } else {
                if (it!=plantDetailViewModel.isAddDelete)
